...
const Footer = () => {
  return (
    <footer className="bg-card border-t border-border pt-14 pb-10 mt-20">
        ...
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div className="space-y-4 md:col-span-1">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-extrabold text-neutral">LocalBite</h2>
            </div>
            <p className="text-sm text-muted-foreground max-w-xs leading-relaxed">
              Bringing neighborhoods together through homemade food, one meal at a
              time.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-10 md:col-span-3 lg:grid-cols-3">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  <Link className="hover:text-primary transition-colors" to="/signup">
                    Become a Cook
                  </Link>
                </li>
                <li>
                  <Link className="hover:text-primary transition-colors" to="/business">
                    For Businesses
                  </Link>
                </li>
              </ul>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  <Link className="hover:text-primary transition-colors" to="/careers">
                    Careers
                  </Link>
                </li>
              </ul>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  <Link className="hover:text-primary transition-colors" to="/demo">
                    Book a Demo
                  </Link>
                </li>
                <li>
                  <Link className="hover:text-primary transition-colors" to="/status">
                    Server Status
                  </Link>
                </li>
                <li>
